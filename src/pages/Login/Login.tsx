...
export const Login = () => {
  ...
  const onLogin = () => {
    ...
    window.location.href = `https://connect.mail.ru/oauth/authorize?client_id=47beccc8bd8c4b2ba04b08c332d4b2d0&response_type=token&redirect_uri=https%3A%2F%2Fmaster--snazzy-palmier-903703.netlify.app%2Flogin`;
  }
